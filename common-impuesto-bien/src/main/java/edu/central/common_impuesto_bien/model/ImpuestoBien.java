...
public class ImpuestoBien implements Serializable {
    ...
    public ImpuestoBien(Impuesto impuesto, Bien bien, boolean pagado, double valorTotalOrdinario, double valorTotalConPagoVoluntario, double valorTotalExtraOrdinario, double valorTotalExtraOrdinarioConPagoVoluntario) {
        Impuesto = impuesto;
        Bien = bien;
        Pagado = pagado;

...
public class ImpuestoBien implements Serializable {
    ...
    private edu.ucentral.servicio.contribuyente.model.Impuesto Impuesto;

    @ManyToOne()
    @JoinColumn(name = "bien_id")
    private edu.ucentral.servicio.contribuyente.model.Bien Bien;
    ...
    public ImpuestoBien(edu.ucentral.servicio.contribuyente.model.Impuesto impuesto, edu.ucentral.servicio.contribuyente.model.Bien bien, boolean pagado, double valorTotalOrdinario, double valorTotalConPagoVoluntario, double valorTotalExtraOrdinario, double valorTotalExtraOrdinarioConPagoVoluntario) {
        Impuesto = impuesto;
        Bien = bien;
        Pagado = pagado;
    ...
    public edu.ucentral.servicio.contribuyente.model.Impuesto getImpuesto() {
        return Impuesto;
    }

    public void setImpuesto(edu.ucentral.servicio.contribuyente.model.Impuesto impuesto) {
        Impuesto = impuesto;
    }

    public edu.ucentral.servicio.contribuyente.model.Bien getBien() {
        return Bien;
    }

    public void setBien(edu.ucentral.servicio.contribuyente.model.Bien bien) {
        Bien = bien;
    }
